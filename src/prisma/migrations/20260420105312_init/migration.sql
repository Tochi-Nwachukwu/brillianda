-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STUDENT', 'TEACHER', 'PARENT', 'ADMIN', 'SCHOOL');

-- CreateEnum
CREATE TYPE "Classes" AS ENUM ('SS3', 'SS2', 'SS1', 'JSS3', 'JSS2', 'JSS1', 'PRIMARY_5', 'PRIMARY_4', 'PRIMARY_3', 'PRIMARY_2', 'PRIMARY_1');
...
-- CreateIndex
CREATE INDEX "School_userId_idx" ON "School"("userId");
...
-- CreateIndex
CREATE INDEX "Class_formTeacherId_idx" ON "Class"("formTeacherId");

-- CreateIndex
CREATE UNIQUE INDEX "Class_level_schoolId_arm_key" ON "Class"("level", "schoolId", "arm");
...
-- CreateIndex
CREATE UNIQUE INDEX "Student_enrollmentNo_schoolId_key" ON "Student"("enrollmentNo", "schoolId");
